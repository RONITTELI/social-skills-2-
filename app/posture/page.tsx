      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">
            See your real-time posture analysis and body positioning.
          </p>
        </div>
        ...
        <div className="mb-16 bg-gradient-to-br from-blue-50 via-white to-blue-50 rounded-3xl p-8 shadow-lg border border-blue-100">
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Live Posture Detection</h2>
            <p className="text-gray-600">See your skeleton and posture analyzed in real-time</p>
          </div>
          <PostureEmotionDemo />
        </div>
